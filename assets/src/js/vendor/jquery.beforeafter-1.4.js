	...
	$.fn.extend({
		beforeAfter: function(options)
		{
			var defaults =
			{
				...
				imagePath : 'http://cdn.thesn.net/assets20130130001/dist/img/ba/',
				cursor: 'pointer',
				clickSpeed: 600,
		...
		var randID =  Math.round(Math.random()*100000000);
			...
			$(obj).prepend('<div id="dragwrapper'+randID+'"><div id="drag'+randID+'"><img width="8" height="56" style="min-width:8px;min-height=56px" alt="handle" src="'+o.imagePath+'handle.gif" id="handle'+randID+'" /></div></div>'); // Create drag handle
