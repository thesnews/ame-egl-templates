{# gryphon/multimedia/templates/audio.tpl #}
			...
			<div class="row-fluid{% if loop.index%2 %} alt{% endif %}">
				<div class="span4">
					...
					{% if image.length %}
						...
						<img src="{{ item.urlPreview }}" /></a>
					{% else %}
						<a href="{{ item.urlDefault }}" class="pull-left btn btn-primary"><i class="icon-play icon-white"></i></a>
					{% endif %}
